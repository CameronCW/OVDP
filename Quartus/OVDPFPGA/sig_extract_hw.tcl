...
# Tue May 27 02:27:23 BST 2025
# DO NOT MODIFY


# 
# sig_extract "sig_extract" v1.0
# Cameron Wade 2025.05.27.02:27:23
# select stereo pair samples, by receive direction & timestamp sig edges, buffer with scan dir
# 
...
# module sig_extract
# 
set_module_property DESCRIPTION "select stereo pair samples, by receive direction & timestamp sig edges, buffer with scan dir"
set_module_property NAME sig_extract
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR "Cameron Wade"
set_module_property DISPLAY_NAME sig_extract
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL sig_extract
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file sig_extract.v VERILOG PATH 3SigExtract/sig_extract.v TOP_LEVEL_FILE
...
add_interface_port split_sync_time split_sync_time export Input 32
...
# 
# connection point left_sample_time
# 
add_interface left_sample_time conduit end
set_interface_property left_sample_time associatedClock clock
set_interface_property left_sample_time associatedReset ""
set_interface_property left_sample_time ENABLED true
set_interface_property left_sample_time EXPORT_OF ""
set_interface_property left_sample_time PORT_NAME_MAP ""
set_interface_property left_sample_time CMSIS_SVD_VARIABLES ""
set_interface_property left_sample_time SVD_ADDRESS_GROUP ""

add_interface_port left_sample_time left_sample_time export Output 32


# 
# connection point right_sample_time
# 
add_interface right_sample_time conduit end
set_interface_property right_sample_time associatedClock clock
set_interface_property right_sample_time associatedReset ""
set_interface_property right_sample_time ENABLED true
set_interface_property right_sample_time EXPORT_OF ""
set_interface_property right_sample_time PORT_NAME_MAP ""
set_interface_property right_sample_time CMSIS_SVD_VARIABLES ""
set_interface_property right_sample_time SVD_ADDRESS_GROUP ""

add_interface_port right_sample_time right_sample_time export Output 32
...
add_interface_port sig_fall_L sig_fall_L export Input 1
...
add_interface_port sig_fall_R sig_fall_R export Input 1
...
add_interface_port sig_rise_L sig_rise_L export Input 1
...
add_interface_port sig_rise_R sig_rise_R export Input 1
